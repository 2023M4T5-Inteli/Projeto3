 ...
 const char* ssid = "Enya"; //Nome da rede
 const char* password = "eunaosei"; //Senha da rede
 WiFiClient espClient;
 
 
 //Credenciais do MQTT para que o ESP32 consiga criar e publicar mensagens no topico
 const char* mqtt_server = "broker.hivemq.com"; //Servidor MQTT, pode ser um Broker online, mas nesse caso escolhemos Local Host
 const char* inTopic = "data/esp"; //Topico em que a mensagem sera publicada
...
//Funcao que conecta ao Wi-Fi
 void WiFiConnect() {
   ...
   Serial.print("Connecting to "); //Printa essa mensagem enquanto esta tentando conexao2
   Serial.println(ssid);
